...
import { CardMedia, Typography, ListItem,  List, Card, CardHeader, Divider, CardContent} from "@mui/material";
              ...
              {photo.comments && photo.comments.length > 0 ? (
                photo.comments.map((comment) => (
                  <ListItem key={comment._id} alignItems="flex-start" style={{ flexDirection: "column" }}>
                    ...
                    <Divider variant="fullWidth" style={{ width: "100%", marginTop: "10px" }} />
                  </ListItem>
                ))
              ) : (
